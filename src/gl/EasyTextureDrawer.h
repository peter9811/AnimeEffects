...
public:
    ...
    void draw(GLuint aTexture, const std::array<QVector2D, 4>& aPosQuad, const QSize& aPosCoord,
        const std::array<QVector2D, 4>& aTexQuad, const QSize& aTexCoord);
    void draw(GLuint aTexture);
    void draw(GLuint aTexture, const QRectF& aPosRect, const QSize& aPosCoord, const QRectF& aTexRect,
