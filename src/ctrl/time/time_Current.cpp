...
namespace time {
    ...
    //-------------------------------------------------------------------------------------------------
    Current::Current(int aLeftMargin): mLeftMargin(aLeftMargin), mMaxFrame(0), mFrame(0), mPos() { mPos.setY(11); }

    void Current::setMaxFrame(int aMaxFrame) { mMaxFrame = aMaxFrame; }
    ...
    void Current::update(const Scaler& aScale) { mPos.setX(mLeftMargin + aScale.pixelWidth(mFrame.get())); }
