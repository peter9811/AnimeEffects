...
namespace mesh {
    ...
    public:
        ...
        MeshVtx* vtxFocus() const {
            return mFocus.vtx;
        }
        MeshEdge* edgeFocus() const {
            return mFocus.edge;
        }
        MeshFace* faceFocus() const {
            return mFocus.face;
        }

        void selectFace(MeshFace* aFace) {
            mSelecting.face = aFace;
        }
        void selectEdge(MeshEdge* aEdge) {
            mSelecting.edge = aEdge;
        }
        void selectVtx(MeshVtx* aVtx) {
            mSelecting.vtx = aVtx;
        }
        MeshFace* selectingFace() const {
            return mSelecting.face;
        }
        MeshEdge* selectingEdge() const {
            return mSelecting.edge;
        }
        MeshVtx* selectingVtx() const {
            return mSelecting.vtx;
        }
        void clearSelection() {
            mSelecting = Focus();
        }
