...
QString getBlendNameFromBlendMode(BlendMode aMode)
{
    ...
    case BlendMode_ColorBurn:   return BlendModeName::tr("Color Burn");
    case BlendMode_LinearBurn:  return BlendModeName::tr("Linear Burn");
    case BlendMode_Lighten:     return BlendModeName::tr("Lighten");
    case BlendMode_Screen:      return BlendModeName::tr("Screen");
    case BlendMode_ColorDodge:  return BlendModeName::tr("Color Dodge");
    case BlendMode_LinearDodge: return BlendModeName::tr("Linear Dodge");
    case BlendMode_Overlay:     return BlendModeName::tr("Overlay");
    case BlendMode_SoftLight:   return BlendModeName::tr("Soft Light");
    case BlendMode_HardLight:   return BlendModeName::tr("Hard Light");
    case BlendMode_VividLight:  return BlendModeName::tr("Vivid Light");
    case BlendMode_LinearLight: return BlendModeName::tr("Linear Light");
    case BlendMode_PinLight:    return BlendModeName::tr("Pin Light");
    case BlendMode_HardMix:     return BlendModeName::tr("Hard Mix");
