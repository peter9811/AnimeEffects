...
TimeKeyExpans::TimeKeyExpans():
    mMasterCache(), mKeyCaches(), mSRT(), mOpa(), mHSV(), mWorldOpacity(1.0f), mDepth(), mWorldDepth(), mBone(),
    mPose(), mPoseParent(), mPosePalette(), mAreaMeshKey(), mFFD(), mFFDMesh(), mFFDMeshParent(), mAreaImageKey(),
    mImageOffset() {
    clearCaches();
}
