...
namespace ffd {
    ...
    private:
        ...
        void buildShader(gl::EasyShaderProgram& aProgram, const QString& aCode, int aType, int aHard);
        void buildBlurShader(gl::EasyShaderProgram& aProgram, const QString& aCode);
